...
<link href="${ctx }/resources/css/style.css" rel='stylesheet'
	type='text/css' />
<!-- Graph CSS -->
<link href="${ctx }/resources/css/lines.css" rel='stylesheet'
	type='text/css' />
	...
	<div class="graphs">
					...
					<div class="scrollbar" id="style-2">
						<div class="activity-row">
							...
							<div class="col-xs-3 activity-img">
								<img src='${ctx }/resources/images/5.png' class="img-responsive"
									alt="" />
							</div>
						...
						<div class="activity-row">
							...
							<div class="col-xs-3 activity-img">
								<img src='${ctx }/resources/images/3.png' class="img-responsive"
									alt="" />
							</div>
							<div class="col-xs-8 activity-desc">
								<h5>
						...
						<div class="activity-row">
							...
							<div class="col-xs-3 activity-img">
								<img src='${ctx }/resources/images/1.png' class="img-responsive"
									alt="" />
							</div>
							<div class="col-xs-8 activity-desc">
								<h5>
						...
						<div class="activity-row1">
							...
							<div class="col-xs-3 activity-img">
								<img src='${ctx }/resources/images/4.png' class="img-responsive"
									alt="" />
							</div>
							<div class="col-xs-8 activity-desc">
								<h5>
			...
			<div class="col-md-4 stats-info">
				...
				<div class="panel-body">
					<ul class="list-unstyled">
						...
						<li>Firefox
							<div class="text-success pull-right">
								15%<i class="fa fa-level-up"></i>
							</div>
						</li>
						<li>Internet Explorer
							<div class="text-success pull-right">
								18%<i class="fa fa-level-up"></i>
							</div>
						</li>
						<li>Safari
							<div class="text-danger pull-right">
								17%<i class="fa fa-level-down"></i>
							</div>
						</li>
						<li>Opera
							<div class="text-danger pull-right">
		...
		<div class="span_11">
			<div class="col-md-6 col_4">
				...
				<!----Calender -------->
				<link rel="stylesheet" href="${ctx }/resources/css/clndr.css"
					type="text/css" />
				<script src="${ctx }/resources/js/underscore-min.js"
					type="text/javascript"></script>
				<script src="${ctx }/resources/js/moment-2.2.1.js"
					type="text/javascript"></script>
			...
			<div class="col-md-6 col_5">
				...
				<!-- map -->
				<link href="${ctx }/resources/css/jqvmap.css" rel='stylesheet'
					type='text/css' />
				<script src="${ctx }/resources/js/jquery.vmap.js"></script>
				<script src="${ctx }/resources/js/jquery.vmap.sampledata.js"
					type="text/javascript"></script>
				<script src="${ctx }/resources/js/jquery.vmap.world.js"
					type="text/javascript"></script>
			...
			<div class="col-md-4 span_4">
				<div class="cloud">
					<div class="grid-date">
						...
						<h4>
							30°<i class="fa fa-cloud-upload"> </i>
						</h4>
					</div>
